...
import com.yosha10.qday.API.APIRequestData;
import com.yosha10.qday.API.RetroServer;
import com.yosha10.qday.Adapter.AdapterQuote;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onResume() { // Lifecyle pertama yang dijalankan onCreate, lalu onStart, onResume, onPaused
        super.onResume();
        retrieveData();
    }
    ...
    private void retrieveData(){
        ...
        Call<List<QuoteModel>> retrieveProcess = ARD.ardRetrieve(); // Menghubungkan
